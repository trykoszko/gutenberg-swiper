 ...
 * @since 1.0.0
 */
function mt_swiper_block_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'mt_swiper_block-cgb-style-css', // Handle.
	...
	wp_register_script(
		'mt_swiper_block-cgb-block-js', // Handle.
	...
	wp_register_style(
		'mt_swiper_block-cgb-block-editor-css', // Handle.
